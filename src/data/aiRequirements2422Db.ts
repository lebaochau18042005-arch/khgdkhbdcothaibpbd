...
export const AI_REQUIREMENTS_2422_DB: AiRequirementItem[] = [
  ...
  // NLa - Lớp 12
  {
    ...
    componentName: "Tư duy lấy con người làm trung tâm",
    topic: "A1",
    topicName: "Lãnh đạo và quản trị trong kỷ nguyên AI",
    requirementType: "CỐT_LÕI",
    requirementText: "Thể hiện được tư duy độc lập và năng lực làm chủ công nghệ; đưa ra phán đoán phản biện và quyết định cuối cùng trong các tình huống chuyên sâu của môn học.",
    sourceDocumentId: "DOC-2026-QD2422",
    sourcePage: 36,
    isCore: true,
    isExtension: false,
  ...
  // NLc - Lớp 12
  {
    ...
    componentName: "Các kĩ thuật và ứng dụng AI",
    topic: "C3",
    topicName: "Khai thác hệ thống AI chuyên ngành",
    requirementType: "CỐT_LÕI",
    requirementText: "Sử dụng thành thạo các mô hình AI chuyên ngành để mô phỏng thí nghiệm, phân tích cấu trúc không gian, giải toán vi tích phân hoặc phân tích dữ liệu lịch sử/địa lí chuyên sâu.",
    sourceDocumentId: "DOC-2026-QD2422",
    sourcePage: 41,
    isCore: true,
    isExtension: false,
  ...
  },
  {
    ...
    componentName: "Các kĩ thuật và ứng dụng AI",
    topic: "C4",
    topicName: "Fine-tuning và Prompt Engineering nâng cao",
    requirementType: "MỞ_RỘNG",
    requirementText: "Thiết lập cấu trúc prompt theo hệ thống vai trò chuyên gia phức tạp, kiểm soát tham số nhiệt độ/độ ngẫu nhiên và hướng dẫn AI giải quyết bài toán nghiên cứu.",
    sourceDocumentId: "DOC-2026-QD2422",
    sourcePage: 42,
    isCore: false,
    isExtension: true,
  ...
  // NLd - Lớp 12
  {
    ...
    componentName: "Thiết kế, thử nghiệm và cải tiến hệ thống AI",
    topic: "D1",
    topicName: "Thiết kế dự án nghiên cứu học tập ứng dụng AI",
    requirementType: "CỐT_LÕI",
    requirementText: "Xây dựng và thực hiện một dự án học tập hoàn chỉnh có ứng dụng AI từ bước thu thập dữ liệu, xử lý, phân tích đến báo cáo kết quả và đánh giá.",
    sourceDocumentId: "DOC-2026-QD2422",
    sourcePage: 43,
    isCore: true,
    isExtension: false,
  ...
  },
  {
    ...
    componentName: "Thiết kế, thử nghiệm và cải tiến hệ thống AI",
    topic: "D2",
    topicName: "Tối ưu hóa và kiểm định giải pháp AI",
    requirementType: "CHUYÊN_ĐỀ",
    requirementText: "Thực hiện kiểm thử áp lực, phát hiện các lỗ hổng logic/sai số và cải tiến giải pháp AI đảm bảo độ chính xác và an toàn thông tin tối đa.",
    sourceDocumentId: "DOC-2026-QD2422",
    sourcePage: 45,
    isCore: false,
    isExtension: true,
